...
function miniprogram_subscribe_message_count( ) {
    ...
    $we_success    = get_miniprogram_notice_success_count( '', 'WeChat');
    $qq_success    = get_miniprogram_notice_success_count( '', 'QQ');
    $total_success = $we_success + $qq_success;
    $total_push    = $wetotal_push + $qqtotal_push;
    $total_round   = $total_push ? round($total_success/$total_push*100,2) : 0;
?>
    <div class="wrap">
