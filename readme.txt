...
重要：Ver 1.4.4 核心文件及路由接口变化较大，需要同步更新小程序，请谨慎更新
...
5.更新优化文章和评论相关路由接口
6.更新优化通知消息模板页面过滤器
7.更新文章发布增加激励视频广告开启设置
8.更新优化用户信息获取，更新及上传头像接口
9.更新优化订阅消息通知模板路径及内容过滤器
10.更新优化文章自定义字段面板模块和数据过滤器
...
1. 更新优化后端框架选择样式
2. 更新优化后端框架数据类型
3. 更新移除 QQ 授权登录接口 do_action
4. 更新扩展账号注册、登录及重置密码接口
